...
class Windows(QtWidgets.QWidget):
    ...
    def _build_ui(self):
        ...
        def run_js():
            if self.js.strip():
                self.webview.page().runJavaScript(self.js)

        self.webview.loadFinished.connect(lambda ok: run_js())
...
class Linux:
    def __init__(self):
        print("Linux widget support is not available yet.")

class Macos:
    def __init__(self):
        print("macOS widget support is not available yet.")

class Ios:
    def __init__(self):
        print("iOS widget support is not available yet.")
